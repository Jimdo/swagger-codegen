...
class FakeApi {
  ...
  Future<OuterBoolean> fakeOuterBooleanSerialize({ OuterBoolean body }) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'OuterBoolean') as OuterBoolean ;
    } else {
      return null;
    }
  }
  ...
  Future<OuterComposite> fakeOuterCompositeSerialize({ OuterComposite body }) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'OuterComposite') as OuterComposite ;
    } else {
      return null;
    }
  }
  ...
  Future<OuterNumber> fakeOuterNumberSerialize({ OuterNumber body }) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'OuterNumber') as OuterNumber ;
    } else {
      return null;
    }
  }
  ...
  Future<OuterString> fakeOuterStringSerialize({ OuterString body }) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'OuterString') as OuterString ;
    } else {
      return null;
    }
  }
  ...
  Future<Client> testClientModel(Client body) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Client') as Client ;
    } else {
      return null;
    }
  }
  ...
  ///
  /// Fake endpoint for testing various parameters 假端點 偽のエンドポイント 가짜 엔드 포인트 
  Future testEndpointParameters(num number, double double_, String patternWithoutDelimiter, ByteArray byte, { int integer, int int32, int int64, double float_, String string, String binary, DateTime date, DateTime dateTime, String password, String callback }) async {
    ...
    if(double_ == null) {
     throw new ApiException(400, "Missing required param: double_");
    }
    ...
    if(contentType.startsWith("multipart/form-data")) {
      ...
      if (float_ != null) {
        hasFields = true;
        mp.fields['float'] = parameterToString(float_);
      }
      
      if (double_ != null) {
        hasFields = true;
        mp.fields['double'] = parameterToString(double_);
      }
...
if (float_ != null)
        formParams['float'] = parameterToString(float_);
if (double_ != null)
        formParams['double'] = parameterToString(double_);
if (string != null)
...
if (callback != null)
  ...
  ///
  /// To test enum parameters
  Future testEnumParameters({ ModelList<String> enumFormStringArray, String enumFormString, ModelList<String> enumHeaderStringArray, String enumHeaderString, ModelList<String> enumQueryStringArray, String enumQueryString, int enumQueryInteger, double enumQueryDouble }) async {
    Object postBody = null;
