...
class ReadOnlyFirst {
  ...
  static List<ReadOnlyFirst> listFromJson(List<Map<String, dynamic>> json) {
    var list = new List<ReadOnlyFirst>();
    if (json != null && json.length > 0) {
      json.forEach((Map<String, dynamic> value) => list.add(new ReadOnlyFirst.fromJson(value)));
    }
    return list;
  }
